...
export function Projects({ theme }: ProjectsProps) {
  ...
  return (
    <>
      <h2 className={`text-4xl md:text-5xl font-bold mb-16 pb-4 border-b ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
        Projelerim
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        {websites.map((website) => (
          <div
            ...
            } shadow hover:shadow-xl transform hover:-translate-y-1`}
          >
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-cyan-500 to-purple-600 opacity-0 group-hover:opacity-5 transition-opacity duration-500" />
            <div className="flex flex-col h-full">
              <div className="aspect-[4/3] overflow-hidden">
                <div className="w-full h-full relative bg-gray-300 flex items-center justify-center">
                  {website.screenshot ? (
                    <img 
              ...
              <div className="flex flex-col flex-grow p-4">
                <div className="flex items-start gap-2 mb-2">
                  <span className="inline-block mt-1">{website.icon}</span>
                  <div>
                    <h3 className="text-base font-bold leading-tight mb-1">{website.name}</h3>
                ...
                <p className={`mb-3 text-xs leading-relaxed line-clamp-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                  {website.description}
                </p>
                <div className="mt-auto">
                  <div className="flex flex-wrap gap-1 mb-3">
                    {website.technologies.slice(0, 2).map((tech, index) => (
                      <span 
                        key={index}
                    ...
                    {website.technologies.length > 2 && (
                      <button
                        ...
                        className={`px-1.5 py-0.5 text-[10px] rounded transition-all duration-300 hover:scale-105 z-[60] relative ${
                          theme === 'dark'
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    <a
                      ...
                      } text-white shadow hover:shadow-lg transform hover:-translate-y-0.5`}
                    >
      ...
      {showModal && selectedProject && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          />
          <div className={`relative w-full max-w-2xl rounded-3xl shadow-2xl ${
            theme === 'dark' 
              ? 'bg-gray-800' 
              : 'bg-white'
          } p-8 md:p-10`}>
